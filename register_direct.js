// register_direct.js - Logic đăng ký nghiệp vụ DHM8 (Dành riêng cho luồng Direct)
// Bao gồm: UUID generation, POST no-cors, JSONP polling, retry/backoff, UI state.
// SCOPE: Nghiệp vụ đăng ký trực tiếp. Analytics (fire-and-forget) nằm trong tracking.js.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        // --- Chuẩn hóa Referrer cho luồng đăng ký trực tiếp (Không có radio đối tác) ---
        ...
        data.source = 'Web_DHM8_Direct'; // Đặt nguồn đăng ký trực tiếp
